 ...
 */
@Config
public class OdometryGlobalCoordinatePositionTask {
    //Odometry wheels
    ...
    //Algorithm constants
    public static double robotEncoderWheelDistance = 15;
    public static double horizontalEncoderTickPerDegreeOffset = -654;
     ...
     */
    public OdometryGlobalCoordinatePositionTask(SandsRobot robot){
